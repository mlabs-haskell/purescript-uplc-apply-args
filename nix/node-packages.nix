...
let
  sources = {
    ...
    "@aws-sdk/types-3.709.0" = {
      ...
      version = "3.709.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-sdk/types/-/types-3.709.0.tgz";
        sha512 = "ArtLTMxgjf13Kfu3gWH3Ez9Q5TkDdcRZUofpKH3pMGB/C6KAbeSCtIIDKfoRTUABzyGlPyCrZdnFjKyH+ypIpg==";
      };
    };
    ...
    "@mlabs-haskell/uplc-apply-args-2.0.1" = {
      name = "_at_mlabs-haskell_slash_uplc-apply-args";
      packageName = "@mlabs-haskell/uplc-apply-args";
      version = "2.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@mlabs-haskell/uplc-apply-args/-/uplc-apply-args-2.0.1.tgz";
        sha512 = "of0zlgBEk9vpTBFISDHADoYRzfbw84MQBMnGCXFhdSvdOIWsoGV4kvQJBdufYYh8BJNSyy0MLJ9uX7ARr7reig==";
      };
    };
    "@mlabs-haskell/uplc-apply-args-browser-0.0.3" = {
      name = "_at_mlabs-haskell_slash_uplc-apply-args-browser";
      packageName = "@mlabs-haskell/uplc-apply-args-browser";
      version = "0.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@mlabs-haskell/uplc-apply-args-browser/-/uplc-apply-args-browser-0.0.3.tgz";
        sha512 = "U2GFMN2Q2KLwTKjrwDXcOBznIvib3Jvdg79xmXDx3/L94PGoBfLN9bBByfVTwKP+ETRfJgRXwi5xxctwKXvT+g==";
      };
    };
    "@mlabs-haskell/uplc-apply-args-nodejs-0.0.3" = {
      name = "_at_mlabs-haskell_slash_uplc-apply-args-nodejs";
      packageName = "@mlabs-haskell/uplc-apply-args-nodejs";
      version = "0.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@mlabs-haskell/uplc-apply-args-nodejs/-/uplc-apply-args-nodejs-0.0.3.tgz";
        sha512 = "0uLz+67U1yiXvt3qu/7NBd0WK6LWXf9XteaInQk56RqRbxi4WKA/1Rm73VuciZzLWohXMDNbVNCiirmXi6k+9A==";
      };
    };
    "@noble/ed25519-2.1.0" = {
  ...
  args = {
    ...
    packageName = "purescript-uplc-apply-args";
    src = ./..;
    dependencies = [
      sources."@aws-crypto/crc32-5.2.0"
      sources."@aws-crypto/util-5.2.0"
      sources."@aws-sdk/types-3.709.0"
      ...
      sources."@mlabs-haskell/uplc-apply-args-2.0.1"
      sources."@mlabs-haskell/uplc-apply-args-browser-0.0.3"
      sources."@mlabs-haskell/uplc-apply-args-nodejs-0.0.3"
